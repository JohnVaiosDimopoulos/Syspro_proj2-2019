...
class Sender {
 private:
  ...
  void Recursively_go_Through_dir_and_send(const char *current_path_relative_to_input_dir,
                                           const char *current_dir_full_path);
  ...
  void Send_through_pipe(const char *full_file_path, const char *file_path_relative_to_input);
